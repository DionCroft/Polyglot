...
[Mac beta release](https://github.com/DionCroft/Polyglot/releases/tag/macos-v0.5.0b1): native DMG (1,095,587,995 bytes) and app ZIP (1,051,140,329 bytes), plus installation instructions and [SHA-256 checksums](macos-0.5.0b1-SHA256SUMS.txt).

[Publication workflow](https://github.com/DionCroft/Polyglot/actions/runs/35623443406) transferred the exact native artifacts inside GitHub and verified both against their build checksums before publication. GitHub's reported SHA-256 asset digests were independently compared with those checksums and matched. The release is a public prerelease, not a draft. Its tag includes later documentation; the application source revision used by the build is recorded above.
