...
w.overlay.enqueue(Caption(1,0,5,'The interrupt service routine should execute as quickly as possible.','中断服务程序应尽快执行。',True));w.overlay.show();w.overlay.lock(True)
def report():
